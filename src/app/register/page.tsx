  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        setError(error.message || 'Erro desconhecido ao criar conta');
      } else {
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Comece a usar a Nutrimatic hoje mesmo
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              Já tem uma conta?{' '}
              <Link href="/login" className="text-nutrimatic-600 hover:text-nutrimatic-700 font-medium">
                Faça login
              </Link>
            </p>
          </div>
